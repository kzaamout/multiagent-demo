...
#plan("POWER PLAN, MAIN FLOOR", [
  ...
  + Circuit tags name the panel and circuit. Receptacle circuits tagged LP-1 are on panel schedule LP-1, sheet E-002; those tagged LP-2 are on panel schedule LP-2, sheet E-003.
  ...
  + Panel LP-2 is in the staff workroom and serves the program room receptacles. Its schedule is on sheet E-003.
], {
  ...
  // Panel LP-2 in the staff workroom.
  at(23.3, 19.35, box(width: m(1.4), height: m(0.4), stroke: 1.2pt + ink, fill: ink))
  at(23.4, 18.6, text(size: 6.5pt, weight: "bold")[LP-2])
