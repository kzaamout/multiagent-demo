...
#box(width: 100%, height: 165mm, {
  ...
  // Panel LP-2, fed from LP-1.
  wire(289mm, 116mm, 289mm, 126mm)
  node(260mm, 126mm, 58mm, 30mm, [#text(size: 9pt, weight: "bold")[LP-2, NEW] \ 30-circuit panelboard, 100 A \ 120/208 V, 3 phase, 4 wire \ Staff workroom. See schedule E-003])
  label(214mm, 134mm, block(width: 44mm, text(size: 7pt)[
    #text(weight: "bold")[FEEDER F2, NEW] \
    Feeder, 4C plus ground, 100A in EMT \
    Length: 14 m, LP-1 to LP-2 \
    100 A / 3P breaker in LP-1
  ]))
  // Ground.
  ...
  // Scope boundary.
  place(top + left, dx: 104mm, dy: 40mm, rect(width: 220mm, height: 118mm, stroke: (paint: rgb("#2b4c7e"), thickness: 1pt, dash: "dash-dotted")))
...
+ Panel LP-2 serves the program room. Its schedule is on sheet E-003.
