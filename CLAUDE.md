...
11. A prospect's documents are never committed. Real files stay out of git until they are redacted and the prospect has cleared them, and even then they are dropped into an ignored `inputs/` folder locally. On 2026-09-16 three unredacted North Pointe drawings reached a public GitHub repository this way; the history was rewritten and the repository recreated. Before any push, check what is being published, not only that credentials are absent.
