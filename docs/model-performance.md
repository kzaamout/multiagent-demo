...
Runs recorded: 79, of which 79 called a model. Estimated spend across all of them: $9.82. Sweeps included: stage-1, stage-1-escalate, stage-1-pilot, stage-1-untaught, writer-check.
...
|---|---|---|---|---|---|---|---|
| orchestrator | qwen3.5 9b, local, temperature 0.1, num_ctx 65536, think off, max_tokens model default | 49 | 0 | 12/49 (24%) | 98% | 6.4 | none qualified |
| intake | qwen3.5 9b, local, temperature 0.1, num_ctx 65536, think off, max_tokens model default | 70 | 5 | 62/84 (74%) | 70% | 16.0 | none qualified |
| estimator | qwen3.5 9b, local, temperature model default, num_ctx 65536, think off, max_tokens model default | 24 | 7 | 15/24 (62%) | 26% | 10.9 | none qualified |
| pricing | qwen3.5 9b, local, temperature 0.1, num_ctx 65536, think off, max_tokens model default | 34 | 2 | 25/34 (74%) | 60% | 18.3 | none qualified |
| writer | qwen3.5 9b, local, temperature model default, num_ctx 65536, think off, max_tokens model default | 36 | 13 | 20/36 (56%) | 36% | 24.8 | none qualified |
| reviewer | gemma4 12b, local, temperature 0.2, num_ctx 16384, think off, max_tokens model default | 25 | 0 | 13/25 (52%) | 97% | 17.6 | none qualified |
...
| orchestrator | qwen3.5 9b, local | temperature 0.1, num_ctx 65536, think off, max_tokens model default | 3f2ebcc3 | 1 | 2 | 0 | 0/1 (0%) | 100% | 0 | 3592 | 148 | 5.9 | $0.00 |
...
| intake | qwen3.5 9b, local | temperature 0.1, num_ctx 65536, think off, max_tokens model default | 634cab5f | 1 | 4 | 0 | 1/1 (100%) | 100% | 0 | 6930 | 1214 | 21.4 | $0.00 |
...
| pricing | qwen3.5 9b, local | temperature 0.1, num_ctx 65536, think off, max_tokens model default | a21ee64a | 1 | 2 | 0 | 1/1 (100%) | 100% | 0 | 4240 | 640 | 10.3 | $0.00 |
...
| writer | qwen3.5 9b, local | temperature model default, num_ctx 65536, think off, max_tokens model default | 3a18b205 | 1 | 5 | 0 | 1/1 (100%) | 0% | 1 | 7372 | 558 | 8.8 | $0.00 |
...
| reviewer | gemma4 12b, local | temperature 0.2, num_ctx 16384, think off, max_tokens model default | 1ff8732f | 1 | 1 | 0 | 1/1 (100%) | 100% | 0 | 5334 | 47 | 12.4 | $0.00 |
...
| intake | deepseek-r1 14b, local | 1 | wrong_shape 1 |
...
| intake | qwen3.5 9b, local | 42 | checklist_grading 17, no_json 16, other 1, wrong_shape 8 |
...
| estimator | qwen3.5 9b, local | 76 | invalid_json 6, no_json 51, tool_not_used 6, wrong_shape 13 |
...
| writer | qwen3.5 9b, local | 90 | concern_dropped 20, invalid_json 1, no_json 10, provenance_tags 55, wrong_shape 4 |
| reviewer | gemma4 12b, local | 1 | invalid_json 1 |
