...
Runs recorded: 78, of which 78 called a model. Estimated spend across all of them: $9.82. Sweeps included: stage-1, stage-1-escalate, stage-1-pilot, stage-1-untaught.
...
|---|---|---|---|---|---|---|---|
| orchestrator | qwen3.5 9b, local, temperature 0.1, num_ctx 65536, think off, max_tokens model default | 48 | 0 | 12/48 (25%) | 98% | 6.4 | none qualified |
| intake | qwen3.5 9b, local, temperature 0.1, num_ctx 65536, think off, max_tokens model default | 69 | 5 | 61/83 (73%) | 69% | 15.9 | none qualified |
| estimator | qwen3.5 9b, local, temperature model default, num_ctx 65536, think off, max_tokens model default | 23 | 7 | 15/23 (65%) | 25% | 11.1 | none qualified |
| pricing | qwen3.5 9b, local, temperature 0.1, num_ctx 65536, think off, max_tokens model default | 33 | 2 | 24/33 (73%) | 59% | 18.5 | none qualified |
| writer | qwen3.5 9b, local, temperature model default, num_ctx 65536, think off, max_tokens model default | 35 | 13 | 19/35 (54%) | 37% | 25.2 | none qualified |
| reviewer | gemma4 12b, local, temperature 0.2, num_ctx 16384, think off, max_tokens model default | 24 | 0 | 12/24 (50%) | 97% | 17.8 | none qualified |
...
| intake | deepseek-r1 14b, local | 1 | checklist_grading 1 |
| intake | gemma4 12b, local | 1 | checklist_grading 1 |
| intake | llama3.1 8b, local | 3 | checklist_grading 2, tool_not_used 1 |
| intake | qwen3.5 4b, local | 2 | json_shape 2 |
| intake | qwen3.5 9b, local | 42 | checklist_grading 23, json_shape 18, other 1 |
| estimator | claude-sonnet-5 via Bedrock | 2 | missing_fields 2 |
| estimator | gemma4 12b, local | 2 | json_shape 1, output_limit 1 |
| estimator | qwen3.5 4b, local | 5 | json_shape 3, tool_not_used 2 |
| estimator | qwen3.5 9b, local | 72 | json_shape 57, missing_fields 9, tool_not_used 6 |
...
| writer | qwen3.5 9b, local | 88 | concern_dropped 18, json_shape 15, provenance_tags 55 |
