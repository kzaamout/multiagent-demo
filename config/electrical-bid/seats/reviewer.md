...
Until compiled page images are available, you receive the draft as markdown. Cite section headings instead of page numbers, and skip the on-page presentation checks you cannot see.
